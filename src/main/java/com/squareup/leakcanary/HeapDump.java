...
public final class HeapDump implements Serializable {
    ...
    public HeapDump(File heapDumpFile, String referenceKey,
                    String referenceName, ExcludedRefs excludedRefs,
    ...
    public HeapDump renameFile(File newFile) {
        ...
        return new HeapDump(newFile, referenceKey, referenceName, excludedRefs,
