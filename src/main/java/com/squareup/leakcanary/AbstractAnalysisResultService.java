...
public abstract class AbstractAnalysisResultService extends IntentService {
    ...
    public static void sendResultToListener(Context context,
                                            String listenerServiceClassName, HeapDump heapDump,
    ...
    protected final void onHandleIntent(Intent intent) {
        HeapDump heapDump = (HeapDump) intent
                .getSerializableExtra(HEAP_DUMP_EXTRA);
        AnalysisResult result = (AnalysisResult) intent
                .getSerializableExtra(RESULT_EXTRA);
        try {
...
//            heapDump.heapDumpFile.delete();
     ...
     * Check {@link AnalysisResult#leakFound} and
     * {@link AnalysisResult#excludedLeak} to see if there was a leak and if it
     * can be ignored.
     * <p/>
     ...
     * <p/>
     * The heap dump file will be deleted immediately after this callback
     * returns.
     */
    protected abstract void onHeapAnalyzed(HeapDump heapDump,
                                           AnalysisResult result);
}
