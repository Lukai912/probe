...
/**
 * This service runs in a separate process to avoid slowing down the app process
 * or making it run out of memory.
 */
@SuppressLint("NewApi")
public final class HeapAnalyzerService extends IntentService {
	...
	protected void onHandleIntent(Intent intent) {
		...
		HeapDump heapDump = (HeapDump) intent
				.getSerializableExtra(HEAPDUMP_EXTRA);

		ExcludedRefs androidExcludedDefault = createAndroidDefaults().build();
		HeapAnalyzer heapAnalyzer = new HeapAnalyzer(androidExcludedDefault,
