 ...
 * roots.
 * <p/>
 * This class lets you ignore known memory leaks that you known about. If the
 * shortest path matches {@link ExcludedRefs}, than the heap analyzer should
...
public final class ExcludedRefs implements Serializable {
    ...
    private ExcludedRefs(Map<String, Set<String>> excludeFieldMap,
                         Map<String, Set<String>> excludeStaticFieldMap,
                         Set<String> excludedThreads) {
        // Copy + unmodifiable.
        this.excludeFieldMap = unmodifiableMap(new LinkedHashMap<String, Set<String>>(
                excludeFieldMap));
        this.excludeStaticFieldMap = unmodifiableMap(new LinkedHashMap<String, Set<String>>(
                excludeStaticFieldMap));
        this.excludedThreads = unmodifiableSet(new LinkedHashSet<String>(
                excludedThreads));
    }
    ...
    public static final class Builder {
        ...
        public ExcludedRefs build() {
            return new ExcludedRefs(excludeFieldMap, excludeStaticFieldMap,
                    excludedThreads);
        }
    }
}
